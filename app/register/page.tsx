    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 lg:px-16 py-12">
        ...
        <div className="mb-5">
          ...
          <p className="text-gray-600 text-base">Selamat Bergabung di platform terbaik</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 max-w-md">
          ...
          <div>
            <label className="text-sm font-medium text-[#0F172A] mb-2 block">Confirm Password</label>
            <div className="relative">
              <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#8B5CF6]/50 pointer-events-none" />
              <input
